 ...
 *
 * ==Usage==
 * {{@example import com.flowforge.core.contracts._ final case class V1(id: Long, email: String) final case
 * class V2(id: Long, email: String, age: Int)
 *
 * // Backward‑compatible: producer may add fields implicitly[SchemaConforms[V2, V1, SchemaPolicy.Backward]]
 * }}
 *

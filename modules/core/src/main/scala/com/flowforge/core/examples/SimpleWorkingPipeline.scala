 ...
 * 1. Create type-safe pipeline stages
 * 2. Use functional composition with Kleisli arrows
 * 3. Execute pipelines with proper error handling
 * 4. Demonstrate the architectural patterns
 */
...
/**
 * Simple working pipeline that demonstrates core FlowForge patterns
...
object SimpleWorkingPipeline extends IOApp.Simple {
  ...
  case class ProcessedRecord(id: String, normalizedValue: Double, category: String, processed: Boolean = true)

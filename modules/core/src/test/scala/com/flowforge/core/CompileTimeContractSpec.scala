 ...
 * 
 * These tests demonstrate the key USP of FlowForge: "Pipelines will not even build 
 * if source or target schema do not match or align."
 * 
 * The test shows the API structure and documents the compile-time guarantees.
 * Actual SchemaConforms implementation testing is in the contracts module.
 */
class CompileTimeContractSpec extends AnyWordSpec with Matchers {

  // Test data types
  case class User(id: Long, name: String, email: String)
  case class UserWithAge(id: Long, name: String, email: String, age: Int)

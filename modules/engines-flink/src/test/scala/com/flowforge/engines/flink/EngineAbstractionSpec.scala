...
/**
 * Shared algebra test that proves both Spark and Flink engines 
 * can use the same domain transforms.
 * 
 * This demonstrates FlowForge's engine-agnostic API where business logic
 * is separated from execution engine concerns.
 */

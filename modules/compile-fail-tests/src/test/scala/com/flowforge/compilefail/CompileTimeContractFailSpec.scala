 ...
 * 
 * These tests MUST NOT COMPILE to prove that FlowForge achieves the USP:
 * "Data pipelines won't even compile if contracts/schema of source or target do not match or align!"
 * 
...
class CompileTimeContractFailSpec extends AnyWordSpec with Matchers {
  ...
  case class UserWithAge(id: Long, name: String, email: String, age: Int)  // Extra field
  case class UserMissingEmail(id: Long, name: String)                      // Missing field
  case class UserWrongType(id: String, name: String, email: String)       // Type mismatch

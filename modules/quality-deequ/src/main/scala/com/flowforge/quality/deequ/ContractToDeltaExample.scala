 ...
 *
 * CONTRACT LEVEL: Compile-time schema validation DEEQU LEVEL: Runtime data quality profiling and checks DELTA
 * LEVEL: Table-level constraint enforcement (NOT NULL, CHECK)
 */
object ContractToDeltaExample {
  ...
  /**
   * Utility to generate Delta DDL from FlowForge contracts. This shows how contracts can be translated to
